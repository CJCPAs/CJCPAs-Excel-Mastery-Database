...
**The Complete Excel Reference: 500+ Functions, Real-World Solutions, Plain-English Explanations**

---

## Quick Start: Find What You Need

| **I know the function name** | **I know what I want to do** |
|:----------------------------:|:----------------------------:|
| [Function Reference](#function-reference) | [Solutions Library](#solutions-library) |
| *"I need to learn VLOOKUP"* | *"I need to look up a value"* |
...
*Don't know the function? Start here — organized by what you're trying to accomplish.*

| Solution Guide | What You'll Learn |
|----------------|-------------------|
...
## Excel Features & Tools

| Feature | Description |
|---------|-------------|
| [**Keyboard Shortcuts**](./03-Keyboard-Shortcuts/) | Essential shortcuts for Windows and Mac |
| [**Pivot Tables**](./05-Pivot-Tables/) | Summarize and analyze large datasets |
| [**Conditional Formatting**](./07-Conditional-Formatting/) | Highlight data automatically based on rules |
| [**Data Validation**](./08-Data-Validation/) | Control data entry and prevent errors |
| [**Power Query**](./10-Power-Query/) | Transform and combine data from multiple sources |
| [**Ribbon Reference**](./ribbon-reference/) | Every tab, button, and option documented |
...
|----------|-------------|
| [**Best Practices**](./best-practices/) | Write better formulas, organize workbooks |
| [**Troubleshooting**](./troubleshooting/) | Fix common Excel problems and errors |
| [**Quick Reference**](./13-Quick-Reference/) | Cheat sheets and fast lookup guides |
...
### Advanced
1. Modern Lookups: [XLOOKUP](./functions/lookup-reference/XLOOKUP.md), [FILTER](./functions/lookup-reference/FILTER.md)
...
**On GitHub:** Press `/` to open search, then type function names or tasks

**Quick Links:**
- [A-Z Function Index](./13-Quick-Reference/Functions-A-Z.md) — Find any function
- [Solutions Library](./solutions/) — Find by task
- [Quick Reference](./13-Quick-Reference/) — Cheat sheets
...
*Made for Excel users who want to work smarter, not harder.*
